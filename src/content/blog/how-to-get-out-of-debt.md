...
referentialReading:
  ...
  - title: "Debt Avalanche"
    url: "https://www.investopedia.com/terms/d/debt-avalanche.asp"
    type: "blog"
...
List your debts from smallest balance to largest. Make minimum payments on everything, and put every extra euro toward the smallest balance.
...
|------|---------|------|---------|
| Store card | €1,200 | 12% | €40 |
| Personal loan | €4,000 | 9% | €120 |
| Credit card | €6,500 | 22% | €160 |
| Student loan | €14,000 | 4% | €150 |

With €300 extra per month, the snowball method attacks the store card first -- it's the smallest balance. You'd clear it in about 4 months. Then you roll that €40 into the personal loan. Quick wins, visible progress, growing momentum.
...
List your debts from highest interest rate to lowest. Make minimum payments on everything, and put every extra euro toward the highest-rate debt.

### Same example, different target

Using the same debts, the avalanche method attacks the credit card first -- it's the highest rate at 22%. You'd put all €300 extra toward it every month. It takes longer to see a debt fully eliminated (about 17 months), but every euro is attacking your most expensive debt.
...
**Why it works:** Mathematically optimal. You pay the least amount of total interest over time. In this example, the avalanche saves you hundreds of euros in interest compared to the snowball -- because that 22% credit card was compounding fast while you were busy with the 12% store card.
