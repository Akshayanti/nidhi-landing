...
|---|---|---|
| Asset class | 100% stocks | Stocks + bonds + real estate |
| Geography | One country | Global |
| Sector | One industry | Many industries |
| Company size | Only large caps | Large + mid + small |
| Currency | Only home currency | Multiple currencies |
| Time | One lump sum at one moment | Regular contributions over years |
...
| Year | Sunscreen return | Umbrella return | 50/50 portfolio |
|---|---|---|---|
