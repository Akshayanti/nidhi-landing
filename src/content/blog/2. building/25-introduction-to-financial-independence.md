...
referentialReading:
  ...
  - title: "The Simple Path to Wealth"
    ...
    type: "book"
  - title: "Retirement Spending: Choosing a Sustainable Withdrawal Rate (Trinity Study)"
...
<figure>
<svg viewBox="0 0 720 400" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="fig-cross-title fig-cross-desc">
  <title id="fig-cross-title">The crossover point</title>
  <desc id="fig-cross-desc">Two lines tracked monthly over time. Monthly expenses stay roughly flat. Monthly income from investments starts low and rises as the portfolio grows. They meet at the crossover point: the moment investment income covers expenses for the first time, after which work shifts from obligation to choice.</desc>
  <text class="fig-title" x="360" y="48" text-anchor="middle">The crossover point</text>
  <text class="fig-subtitle" x="360" y="76" text-anchor="middle">When investment income first covers monthly expenses, work becomes a choice</text>
  <line x1="120" y1="116" x2="156" y2="116" class="fig-stroke-warn" stroke-width="2.5" stroke-dasharray="6 4" stroke-linecap="round" />
  <text class="fig-tick" x="164" y="120" text-anchor="start">Monthly expenses</text>
  <line x1="320" y1="116" x2="356" y2="116" class="fig-stroke-teal" stroke-width="3" stroke-linecap="round" />
  <text class="fig-tick" x="364" y="120" text-anchor="start">Monthly investment income</text>
  <line x1="120" y1="240" x2="620" y2="240" class="fig-stroke-warn" stroke-width="2.5" stroke-dasharray="6 4" stroke-linecap="round" />
  <path class="fig-stroke-teal" stroke-width="3" stroke-linecap="round" fill="none" d="M 120 310 Q 320 295 445 240 Q 540 185 620 165" />
  <line x1="445" y1="252" x2="445" y2="320" class="fig-stroke-rule" stroke-dasharray="2 4" />
  <circle cx="445" cy="240" r="14" class="fig-fill-blue" fill-opacity="0.15" />
  <circle cx="445" cy="240" r="7" class="fig-fill-blue" />
  <text class="fig-eyebrow" x="445" y="216" text-anchor="middle" style="fill: var(--color-deep-blue)">CROSSOVER</text>
  <text class="fig-tick" x="120" y="345" text-anchor="middle">today</text>
  <text class="fig-tick" x="370" y="345" text-anchor="middle">→ time →</text>
  <text class="fig-tick" x="620" y="345" text-anchor="middle">later</text>
</svg>
<figcaption>Illustrative. Tracking the two lines monthly turns "financial independence" from an abstract distant target into a moving gap that closes month by month.</figcaption>
</figure>
