...
faq:
  - question: "What is a financial dashboard and what should it contain?"
    answer: "A financial dashboard is a small, known set of metrics reviewed on a known cadence, designed to surface drift early without creating noise. It is not a spreadsheet of everything. A good one has four layers, each checked at a different frequency. Monthly: net worth, cash flow, and savings rate. Quarterly: asset allocation, progress against goals, and emergency fund coverage. Annually: a full financial health review, goal calibration, and projection versus actual. Irregularly: large life events such as a job change or relocation. The point is early signal, not constant measurement. A simple monthly spreadsheet with six columns you actually update beats any fancy system you abandon."
  - question: "How often should I check my finances?"
    answer: "Match the cadence to the timescale of each metric. Net worth is a monthly story, asset allocation a quarterly one, full financial health an annual one. Checking any of those at daily resolution gives you noise, not signal, and noise invites unhelpful action: rebalancing on impulse, selling in a panic, chasing a fund that had a good week. The monthly check-in takes 15 to 30 minutes; the quarterly review 30 to 60 minutes; the annual review two to four hours. Checking too often trains emotional reactions to noise; checking too rarely lets problems become six or nine months old before they surface. Between scheduled check-ins, the dashboard is closed."
  - question: "What should I review monthly versus quarterly versus annually?"
    answer: "Monthly, four numbers carry most of the signal: net worth as a line over time, cash flow for the month, savings rate, and debt balances in payoff mode. Quarterly, zoom out to asset allocation drift, currency allocation if you have cross-border finances, progress against each written goal, emergency fund coverage, and active-versus-passive income composition. Annually, do the full review: the six financial health ratios, goal calibration, projection versus actual, an asset and liability audit, an insurance review, your tax position, estate basics like beneficiaries and a will, and the big-picture question of whether you are on track for the life you want. Event-driven reviews happen outside this cadence when something material changes."
...
referentialReading:
  - title: "Personal Finance Dashboards"
    url: "https://www.investopedia.com/personal-financial-statement-5206617"
    type: "blog"
...
|---|---|---|
| Net worth trend | Direction over 6-12 months | Growing, or clearly-explained dip |
| Monthly cash flow | Positive / negative | Consistently positive |
| Savings rate | Drift over 3-6 months | Stable or rising |
| Debt balances | Declining at expected pace | Yes, or explicitly reprioritised |
...
| Metric | What to watch for | Healthy signal |
|---|---|---|
| Asset allocation | Drift from target > 5-10% | Within tolerance or clear rebalance plan |
| Currency mix | Growing mismatch with future expenses | Roughly aligned, deliberate drift only |
| Goal progress | Behind / on track / ahead | On track within tolerance |
| Emergency fund coverage | Months of expenses covered | At target (typically 3-6 months) |
| Passive income share | Trend over time | Rising (if in accumulation) |
...
| Date | Total assets | Total liabilities | Net worth | Monthly income | Monthly expenses | Monthly savings | Savings rate | Notes |
|---|---|---|---|---|---|---|---|---|
